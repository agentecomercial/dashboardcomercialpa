...
(function () {
  // Console do Treinador (?role=console): a janela é o painel do apresentador,
  // não um deck navegável. O essencial.js assume o controle do DOM ali.
  if (/[?&]role=console/.test(location.search)) return;
