...
(function () {
  ...
  function montarConsole() {
    ...
    raiz.innerHTML = ''
      ...
      +   '</div>'
      /* Coluna direita empilhada: próximo em cima, roteiro embaixo.
         A proporção 30/20 do layout vira 3fr/2fr dentro da coluna. */
      +   '<div class="cs-col cs-dir">'
      +     '<div class="cs-cx">'
      +       '<div class="cs-lbl">Próximo slide <b id="csTitProx"></b></div>'
      +       '<div class="cs-view prox" id="csProx"></div>'
      +     '</div>'
      +     '<div class="cs-cx">'
      +       '<div class="cs-lbl">Roteiro do treinador</div>'
